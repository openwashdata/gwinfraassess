...
| submitted_on | level_measurable | measure_reason | well_depth | depth_unit | depth_over100 | endcap_available | measure_method | measure_datum | casing_length | casing_unit | static_level | level_unit | logger_available | logger_not_available_reason | logger_type | logger_depth | logger_unit | logger_download | download_problem_reason | barlogger_available | barlogger_download | traditional_authority | district | dipper_available | dipper_condition | dipper_problem | ppe_available | community_sensitized | well_purpose | vandalism_reason | vandal_other | vandal_control | control_other | site_importance | importance_other | site_accessible | potable_access | source_type | improvement_plan |
|---:|:---|:---|---:|:---|:---|:---|:---|:---|---:|:---|---:|:---|:---|:---|:---|---:|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|
| 2/8/2022 0:00 | NA | NA | 61.75 | mbgl | No | No | Manual dipper | Groundlevel | NA | NA | 13.86 | m | Yes | NA | Solinst | 29.8 | m | No | No connection to computer | No | NA | NA | NA | NA | NA | NA | NA | Yes | Measuring the water table | People/children are curious to see what is inside | NA | Report to the chief | NA | Other | General ground water level | Yes | Yes | Borehole or tubewell | Replace barologger , Replace end cap, Identify and training gauge reader, Replacement of the level logger |
| 2/8/2022 0:00 | NA | NA | 52.75 | mbgl | Yes | No | Manual dipper | Groundlevel | NA | NA | 3.88 | m | Yes | NA | Solinst | 27.6 | m | No | No connection to computer | No | NA | TA Malenga Chanzi | Nkhotakota | Yes | Good condition | NA | No | Yes | Measuring the water table | Other | Can’t be vandalised | Other | Can’t be vanfalised | Other | General groundwater level | Yes | Yes | Borehole or tubewell | Replace barologger , Replace end cap, Identify and training gauge reader, Replacement of the level logger |
| 2/8/2022 0:00 | NA | NA | 28.40 | mbgl | No | No | Manual dipper | Groundlevel | NA | NA | 4.18 | m | Yes | NA | Solinst | 13.8 | m | No | No connection to computer | Yes | No | NA | NA | Yes | Good condition | NA | No | Yes | Measuring the water table | Other | No possibility of vandalism | Other | No possibility of vandalism | Other | General water level monitoring | Yes | Yes | Piped into public tap / stand pipe / basin | Replace barologger , Replacement of the level logger, Replace end cap, Identify and training gauge reader, Rehabilitation of the civil works |
