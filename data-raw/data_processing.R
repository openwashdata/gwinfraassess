...
gwinfraassess <- data_in

# Export Data ------------------------------------------------------------------
usethis::use_data(gwinfraassess, overwrite = TRUE)
fs::dir_create(here::here("inst", "extdata"))
readr::write_csv(gwinfraassess,
                 here::here("inst", "extdata", paste0("gwinfraassess", ".csv")))
openxlsx::write.xlsx(gwinfraassess,
                     here::here("inst", "extdata", paste0("gwinfraassess",
                                                          ".xlsx")))
